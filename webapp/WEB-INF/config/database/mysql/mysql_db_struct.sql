...
-- group_type: 0 - user group, 1 - entitlement group
--
...
--
-- groups and groups relationship table, relation 0 means group1 is parent of group2
--
DROP TABLE IF EXISTS jforum_groups_groups;
...
--
-- user and groups relationship table
--
...
--
-- Table structure for table 'jforum_recommendation'
--
DROP TABLE IF EXISTS jforum_recommendation;
CREATE TABLE jforum_recommendation (
  ...
  topic_id INT NOT NULL default '0',
  topic_title varchar(100) NOT NULL default '',
  topic_desc varchar(300) NOT NULL default '',
