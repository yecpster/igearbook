...
<table width="100%">
    <tr>
        <td align="right">
        <#assign paginationData><@pagination.doPagination "/url", "list", data /></#assign>${paginationData}
        </td>
    </tr>
</table>
...
<table class="forumline" cellspacing="1" cellpadding="3" width="100%" border="0">
	...
	<#list data.list as url>
			<tr align="center">
			    <td class="row2"><span class="gen">${url_index+1}</span></td>
			    <td class="row2">${url.type}
			    </td>
			    <td class="row2">${url.url}
                </td>
				<#--
	...
	<tr align="center">
		...
		<a href="<@s.url namespace="/url" action="add"></@s.url>">添加</a>
		<@s.submit cssClass="mainoption" value="删除选择的项目" />
		</td>
	</tr>
</table>
</@s.form>
