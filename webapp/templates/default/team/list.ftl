...
<div id="side">
    ...
    <div class="box">
      <h3>群组排名</h3>
              <div class="rank">
          <div class="rank_info">1.<a href="http://pcdiy.group.iteye.com/" target="_blank">电脑DIY</a><br>6852449次</div>
          <div class="rank_logo"><div class="logo"><a href="http://pcdiy.group.iteye.com/" target="_blank"><img src="./ITeye群组频道首页_files/40406440-9eee-3cbe-a70d-f0e69dfedd0b.jpg" alt="电脑DIY群组" title="电脑DIY: 圈主（大家可以称呼我为ice，有些网友喜欢叫冰神）自1997年开始研究电脑DIY，经验极其丰富，教训也是吃足啊，但愿后人不走后悔路，诚心向各位提供咨询服务。纯粹个人业余爱好，如有观点不同很正常，千万不要在圈中随意谩骂。同时谢绝任何形式的广告，推荐可以，广告不行。" height="48" width="48"></a></div></div>
        </div>
              <div class="rank">
          <div class="rank_info">2.<a href="http://jbpm.group.iteye.com/" target="_blank">JBPM @net</a><br>1650572次</div>
          <div class="rank_logo"><div class="logo"><a href="http://jbpm.group.iteye.com/" target="_blank"><img src="./ITeye群组频道首页_files/f37a1679-2f71-4374-9c46-a8b385912ba1.gif" alt="JBPM @net群组" title="JBPM @net: 工作流的运用越来越多，在Java领域最近异军突起的工作流非JBPM莫属了。可是在国内这方面的资料很少，希望可以通过JavaEye这个开源社区把JBPM普及开来！" height="48" width="48"></a></div></div>
        </div>     
    </div>
...
-->
    ...
    <div class="clearfix">
        <div class="groups_title"><span>推荐群组</span> <a href="#" class="more">更多群组</a></div>
            <div class="clearfix">
                <ul class="group">
                  <li class="logo"><div class="logo"><a href="http://verycd.group.iteye.com/" target="_blank"><img src="./ITeye群组频道首页_files/32ddce6e-d8b7-3e68-8ad2-3724ced82155.jpg" alt="电驴资源群组" title="电驴资源: 分享最新电驴资源" height="48" width="48"></a></div> </li>
                  <li class="clearfix"><a href="http://verycd.group.iteye.com/" target="_blank"><strong>电驴资源</strong></a> (77)</li>
                </ul>

                <ul class="group">
                  <li class="logo"><div class="logo"><a href="http://mercury.group.iteye.com/" target="_blank"><img src="./ITeye群组频道首页_files/d51c3e8b-6fc8-31bf-acc6-a5eca0484b57.jpg" alt="水星常驻JE办事处群组" title="水星常驻JE办事处: 理想很丰满，现实很骨感。" height="48" width="48"></a></div> </li>
                  <li class="clearfix"><a href="http://mercury.group.iteye.com/" target="_blank"><strong>水星常驻JE办事处</strong></a> (61)</li>
                </ul>
            </div>
    </div>
  </div>
    ...
    -->
  <p>
  <a href="${JForumContext.encodeURL("/team/insert")}" class="new_group_link">申请群组</a>  &nbsp;&nbsp;
  <a href="" class="my_group_link">我的群组</a>  </p>
      ...
      <h3>近期热门群组</h3>
        ...
        <div class="clearfix hot_group">
          ...
          <div class="info" style="margin-left: 70px;">
            <a href="http://pcdiy.group.iteye.com/">电脑DIY</a><br>
            圈主（大家可以称呼我为ice，有些网友喜欢 ...
          </div>
        </div>
    </div>
