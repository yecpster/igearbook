...
<div id="announcements" class="main">
  <strong>公告</strong>
  <div>圈主提供各种攒机方案，务必说明一下内容预算（包括是否打算以后另加独立显卡）。</div>
</div>
    ...
    <table class="grid">
      ...
      <#list topics as topic>
        ...
        <tr onmouseover="$(this).addClassName(&#39;mouse_over&#39;);" onmouseout="$(this).removeClassName(&#39;mouse_over&#39;);" class="">
          <td>
            <img alt="置顶" src="/top.gif" title="置顶">
            <img alt="精华" src="/good.gif" title="精华">
        ...
        <tr>
          <td colspan="4" style="text-align:right;">&gt; <a href="/group/forum">更多讨论</a></td>
        </tr>
      </tbody>
    </table>
  </div>
...
<div id="group_detail">
   ...
   <#if moderators?has_content>
    ...
    <div class="more"><a href="http://pcdiy.group.iteye.com/group/events">&gt;&gt;更多成员</a></div>
