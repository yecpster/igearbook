    ...
    <div class="box">
      <h3>群组排名</h3>
        ...
        <#if (rankTeam_index < 10)>
            <div class="rank">
              <div class="rank_info">${rankTeam_index + 1}.<a href="<@s.url namespace="/team" action="show"><@s.param name="teamId" value="${rankTeam.id}" /></@s.url>" target="_blank" title="${rankTeam.description?default("")}">${rankTeam.name}</a><br>文章数：${rankTeam.totalPosts}</div>
              <div class="rank_logo"><div class="logo"><a href="<@s.url namespace="/team" action="show"><@s.param name="teamId" value="${rankTeam.id}" /></@s.url>" target="_blank" title="${rankTeam.description?default("")}"><img src="${rankTeam.logo?default("")}" alt="${rankTeam.name}" height="48" width="48"></a></div></div>
            </div>
        </#if>
        </#list>
    </div>
    ...
    <div class="clearfix">
        <div class="groups_title"><span>推荐群组</span> <#--<a href="#" class="more">更多群组</a>--></div>
            <div class="clearfix">
                ...
                <ul class="group">
                  <li class="logo"><div class="logo"><a href="<@s.url namespace="/team" action="show"><@s.param name="teamId" value="${team.id}" /></@s.url>" target="_blank" title="${team.description?default("")}"><img src="${team.logo?default("")}" alt="${team.name}" height="48" width="48"></a></div> </li>
                  <li class="clearfix"><a href="<@s.url namespace="/team" action="show"><@s.param name="teamId" value="${team.id}" /></@s.url>" target="_blank" title="${team.description?default("")}"><strong>${team.name}</strong></a> (${team.totalTopics})</li>
                </ul>
                </#list>
                </#list>
            </div>
    ...
    <div class="box">
      ...
      <#list hotTeams as hotTeam>
        ...
        <div class="clearfix hot_group">
          <div class="logo"><a href="<@s.url namespace="/team" action="show"><@s.param name="teamId" value="${hotTeam.id}" /></@s.url>" target="_blank" title="${hotTeam.description}"><img src="${hotTeam.logo?default("")}" alt="${hotTeam.name}" height="48" width="48"></a></div>
