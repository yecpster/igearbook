...
public class ImageHelper {
    ...
    public static void zoomPicture(String source, int width, int height, String saveName, boolean adjustSize) {
    ...
    private static void thumbnailHandler(String source, int width, int height, String saveName, boolean adjustSize) {
        try {
    ...
    private static void BMPThumbnailHandler(String source, int width, int height, String saveName, boolean adjustSize) {
        try {
            File sourceFile = new File(source);
            if (sourceFile.exists()) {
